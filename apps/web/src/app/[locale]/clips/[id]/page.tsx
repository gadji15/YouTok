...
import { ClipTitlesCard } from "./ui/ClipTitlesCard";
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          ...
          <ClipTitlesCard
            ...
            initialCandidates={clip.title_candidates}
          />
          ...
          <ClipPublishingCard
            ...
            initialCaption={
              clip.tiktok_caption ??
              [
                clip.title_candidates?.description ?? clip.title,
                (clip.title_candidates?.hashtags ?? []).join(' '),
              ]
